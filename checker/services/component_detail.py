...
def get_component_details(request, pk):
    ...
    try:
        ...
        return render(request, "checker/component_detail.html", {
            ...
            "is_geocoded": target_component_obj.geocoded, # Add geocoded status
            "delivery_year": target_component.get("Delivery Year", "N/A") # Add dedicated delivery_year variable
        })
